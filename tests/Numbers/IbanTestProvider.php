...
trait IbanTestProvider
{
    ...
    public function verifyWithInvalidFormatProvider()
    {
        return [
            ...
            // Must contain only digits and characters
            ['AO0600060000010003713117!'],
        ];
    }
    ...
    public function verifyWithUnsupportedCountryCodeProvider()
    {
        return [
            ['AG'],
            ['AI'],
    ...
    public function verifyWithInvalidCountryCodeProvider()
    {
        return [
            ['0750447346'],
            ['2X0750447346'],
    ...
    public function toHumanFormatProvider()
    {
        return [
            [
            ...
            [
                ...
                'BY 13 NBRB 3600 900000002Z00AB00',
            ],
            [
                'BY13 NBRB 3600 9000 0000 2Z00 AB00',
                'BY13 NBRB 3600 900000002Z00AB00',
            ],
            [
    ...
    public function toMachineFormatProvider()
    {
        return [
            [
    ...
    public function toObfuscatedFormatProvider()
    {
        return [
            [
                'DE** **** **** **** **43 21',
    ...
    public function getBbanProvider()
    {
        return [
            [
                '100100100987654321',
